 ...
 *
 * <p>The goal is for the driver to rotate in a perfect circle while the operator holds a button
 * that runs this command, and a Transform2d offset is output.
 */
public class QnavCalibrationCommand extends Command {
  ...
  public QnavCalibrationCommand(Quest quest) {
    this.quest = quest;
  }
  ...
  public void initialize() {
    ...
    quest.setRawQuestPose(Pose3d.kZero);
    ...
    sum_z = 0;
    n = 0;
    lastRotation = RobotState.instance().getRobotPose().getRotation();
  ...
  public void execute() {
    ...
    Rotation2d currentRotation = RobotState.instance().getRobotPose().getRotation();
    ...
    Pose3d qnavPose = quest.getRawQuestPose();
  ...
  public void end(boolean interrupted) {
    ...
    try {
      ...
      System.out.printf(
          "Calculated Quest Offset: X=%f meters, Y=%f meters%n",
