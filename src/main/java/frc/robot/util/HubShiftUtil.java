...
public class HubShiftUtil {
  ...
  public static ShiftInfo getShiftedShiftInfo() {
    ...
    if (shiftSchedule[1] == true) {
      double[] shiftedShiftStartTimes = {0.0, 10.0, 35.0 + 0, 60.0 + 0, 85.0 + 0, 110.0 + 0};
      double[] shiftedShiftEndTimes = {10.0, 35.0 + 0, 60.0 + 0, 85.0 + 0, 110.0 + 0, 140.0};
      return getShiftInfo(shiftSchedule, shiftedShiftStartTimes, shiftedShiftEndTimes);
    }
    double[] shiftedShiftStartTimes = {0.0, 10.0 + 0, 35.0 + 0, 60.0 + 0, 85.0 + 0, 110.0};
    double[] shiftedShiftEndTimes = {10.0 + 0, 35.0 + 0, 60.0 + 0, 85.0 + 0, 110.0, 140.0};
    return getShiftInfo(shiftSchedule, shiftedShiftStartTimes, shiftedShiftEndTimes);
    // }
  }
}
