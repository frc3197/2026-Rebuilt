...
public class IndexConstants implements IndexHardwareID {
    ...
    public static final TalonFXSConfiguration SPINDEX_CONFIG = new TalonFXSConfiguration()
            .withCommutation(
                    new CommutationConfigs().withMotorArrangement(MotorArrangementValue.Minion_JST))
            .withMotorOutput(new MotorOutputConfigs().withInverted(InvertedValue.Clockwise_Positive));

    public static final TalonFXConfiguration FEED_CONFIG = new TalonFXConfiguration()
            .withCurrentLimits(
