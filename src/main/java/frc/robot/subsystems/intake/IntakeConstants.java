...
public class IntakeConstants implements HardwareID.IntakeHardwareID {
  public static final class intakeNumericalConstants {
    public static final double forwardLimit =
        -1.0; // Please find a reasonable value for me (Or switch me to the angle version, figure it
    // out on friday)
    public static final double reverseLimit =
        -1.0; // Please find a reasonable value for me (Or switch me to the angle version, figure it
    // out on friday)
  }

  public static final class motorConfigurationConstants {
    public static final TalonFXConfiguration spinMotorConfig =
